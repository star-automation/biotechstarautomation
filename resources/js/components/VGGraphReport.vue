...
<template>
    <div className="col-md-12" style="padding: 0px;">
        ...
        <h1 style="text-align: center;padding-top: 30px;">Graph Report Of VG</h1>
                    ...
                    <td>
                        <div class="form-group" >
                            ...
                            <select v-model="fields.select_vg"  class="form-control" id="vgs">
                                ...
                                <option value="vg_4">vg 4</option>
                                <option value="vg_5">vg 5</option>
                                <option value="vg_6">vg 6</option>
                                <option value="vg_7">vg 7</option>
                            </select>
                        </div>
                    </td>
                    <td>
        ...
        <div class="container-2 col-md-10 m-auto">
            <table class="col-md-6 table" style="margin: 0 auto; text-align: center; color: white">
                ...
                <tr>
                    <th v-if="fields.select_vg == ''"></th>
                    <th v-if="fields.select_vg == 'vg_1'">vg 1</th>
                    <th v-if="fields.select_vg == 'vg_2'">vg 2</th>
                    <th v-if="fields.select_vg == 'vg_3'">vg 3</th>
                    <th v-if="fields.select_vg == 'vg_4'">vg 4</th>
                    <th v-if="fields.select_vg == 'vg_5'">vg 5</th>
                    <th v-if="fields.select_vg == 'vg_6'">vg 6</th>
                    <th v-if="fields.select_vg == 'vg_7'">vg 7</th>
...
export default {
    ...
    methods: {
        ...
        submit() {
            axios.post('api/vggraphreport', this.fields , {headers: {'Authorization': 'Bearer '+this.currentUser.token}})
                .then((response) => {
                    this.vg = response.data.vg
                    console.log(this.vg)
